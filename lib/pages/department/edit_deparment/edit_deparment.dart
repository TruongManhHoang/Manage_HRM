      ...
      listener: (context, state) {
        if (state is DepartmentSuccess) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Sửa phòng ban thành công'),
            ),
          );
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Sửa phòng ban thất bại: ${state.error}'),
            ),
          );
        }
      },
                          ...
                          child: Column(
                            children: [
                              const TBreadcrumsWithHeading(
                                heading: 'Phòng Ban',
                                breadcrumbItems: [RouterName.editDepartment],
                              ),
                              Container(
                                width: 600,
                                padding:
                                          ...
                                          TextButton(
                                            ...
                                            onPressed: () {
                                              context.go(RouterName
                                                  .departmentPage); // Quay lại trang danh sách
                                            },
                                            child: Text(
                                              'Huỷ',
